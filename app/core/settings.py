...
class Settings(BaseSettings):
    ...
    temporal_bucket: str = config_env.get("TEMPORAL_BUCKET", None)
    front_public_images_es: str = config_env.get("FRONT_PUBLIC_IMAGES_ES", None)
    front_public_images_en: str = config_env.get("FRONT_PUBLIC_IMAGES_EN", None)
