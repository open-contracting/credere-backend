...
def upgrade() -> None:
    op.add_column('credit_product', sa.Column('additional_information',
                                              sqlmodel.sql.sqltypes.AutoString(), nullable=False, server_default=""))
...
def downgrade() -> None:
    ...
    op.alter_column('credit_product', 'interest_rate', type_=postgresql.NUMERIC(5, 2),
